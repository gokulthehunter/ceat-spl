...
<body>
    ...
    <main>
        ...
        <div class="page_head bg-white">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="page_head_cremb">
                            <a href="javascript:void(0)" class="page_head_cremb--link">Home</a>
                            <a class="page_head_cremb--link">CTR</a>
                        </div>
                        <h1 class="page_head--title">Compaction</h1>
                    </div>
                </div>
            </div>
        </div>
        <!-- cremb and heading[end] -->
        <section class="ctr_wrapper">
            ...
            <div class="ctr_wrapper_each bg_light">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="c_title mb-2">
